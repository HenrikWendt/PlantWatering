...
exports.Misc = exports.Me = exports.Store = exports.Vanguard = exports.ColdWar = exports.ModernWarfare = exports.Warzone = exports.friendActions = exports.platforms = exports.login = void 0;
...
class WZ {
    constructor() {
        this.fullData = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        this.combatHistory = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.combatHistoryWithDate = (gamertag, startTime, endTime, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.breakdown = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.breakdownWithDate = (gamertag, startTime, endTime, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.matchInfo = (matchId, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
...
class MW {
    constructor() {
        ...
        this.seasonloot = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.mapList = (platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
...
class SHOP {
    constructor() {
        ...
        this.battlePassLoot = (season, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
...
class USER {
    constructor() {
        this.friendFeed = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
        ...
        this.codPoints = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
        ...
        this.connectedAccounts = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno)
        ...
        this.settings = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
        ...
        this.friendAction = (gamertag, platform, action) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
class ALT {
    constructor() {
        this.search = (gamertag, platform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (platform === platforms.Battlenet || platform === platforms.All || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
